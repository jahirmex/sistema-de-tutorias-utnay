...
<head>
    <meta charset="UTF-8">
    <title>Sistema de Tutorías - Coordinador</title>
    ...
    <div class="row g-0">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-nav">
                <a href="/coordinador/dashboard" class="{{ request()->is('coordinador/dashboard') ? 'active' : '' }}">
                    <i class="bi bi-speedometer2"></i> Dashboard
                </a>

                <a href="/coordinador/alumnos" class="{{ request()->is('coordinador/alumnos') ? 'active' : '' }}">
