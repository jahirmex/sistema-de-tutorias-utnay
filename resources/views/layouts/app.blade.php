...
<head>
    <meta charset="UTF-8">
    <title>Sistema de Tutorías - @yield('title', 'Alumno')</title>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-nav">
                ...
                @if(Auth::user()->role === 'alumno')
                    <a href="{{ route('alumno.dashboard') }}" class="{{ request()->routeIs('alumno.dashboard') ? 'active' : '' }}">
                        <i class="bi bi-speedometer2"></i> <span>Dashboard</span>
                    </a>

                    <a href="{{ route('alumno.mis-tutorias') }}" class="{{ request()->routeIs('alumno.mis-tutorias') ? 'active' : '' }}">
                        <i class="bi bi-calendar-check"></i> <span>Mis Tutorías</span>
                    </a>

                    <a href="{{ route('alumno.solicitar-tutoria') }}" class="{{ request()->routeIs('alumno.solicitar-tutoria') ? 'active' : '' }}">
                        <i class="bi bi-plus-circle"></i> <span>Solicitar Tutoría</span>
                    </a>

                    <a href="{{ route('alumno.mi-tutor') }}" class="{{ request()->routeIs('alumno.mi-tutor') ? 'active' : '' }}">
                        <i class="bi bi-person-badge"></i> <span>Mi Tutor</span>
                    </a>
                @endif
                ...
                @if(Auth::user()->role === 'coordinador')
                    ...
                    <a href="{{ route('alumnos.index') }}">
                        <i class="bi bi-mortarboard"></i> <span>Alumnos</span>
                    </a>
            ...
            <div class="sidebar-footer">
                ...
                <form method="POST" action="{{ route('logout') }}" class="mt-2">
                    @csrf
                    <button class="btn logout-btn w-100 text-start" type="submit">
