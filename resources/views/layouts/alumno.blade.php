...
<head>
    <meta charset="UTF-8">
    <title>Sistema de Tutorías - Alumno</title>
    ...
    <div class="row g-0">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-nav">
                <a href="/alumno/dashboard" class="{{ request()->is('alumno/dashboard') ? 'active' : '' }}">
                    <i class="bi bi-speedometer2"></i> Dashboard
                </a>

                <a href="/alumno/tutorias" class="{{ request()->is('alumno/tutorias') ? 'active' : '' }}">
                    <i class="bi bi-journal-text"></i> Mis tutorías
                </a>

                <a href="/alumno/solicitar-tutoria" class="{{ request()->is('alumno/solicitar-tutoria') ? 'active' : '' }}">
